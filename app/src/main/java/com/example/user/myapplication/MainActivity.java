...
public class MainActivity extends AppCompatActivity implements Gota.OnRequestPermissionsBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecogizer = SpeechRecognizer.createSpeechRecognizer(this);
        mRecogizer.setRecognitionListener(listener);

        button = findViewById(R.id.button);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mRecogizer.startListening(intent);
            }
        });
